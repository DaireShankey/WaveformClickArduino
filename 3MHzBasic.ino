...
public:
    explicit AD9833SineWave(int fsyncPin) : fsyncPin(fsyncPin) { //constructor for sine wave class
...
void setup() {
    ...
    sineWave.setFrequency(3000000); // Set output frequency to 3 MHz

    // Set AD5227 to min resistance to achieve maximum amplitude
    setAD5227Position(0); // Set to minimum resistance for max amplitude
}
